    ...
    return Row(
      ...
      children: [
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text('VinNutri AI', style: TextStyle(fontSize: 26, fontWeight: FontWeight.w900, color: darkText)),
            const SizedBox(height: 4),
            Text('Chào $userName!', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: mediumText)),
          ],
        ),
        Container(
          width: 50, height: 50,
